...
def buttons_img_overlay(labels, stby=False):
    ...
    draw_buttons.rectangle([(0, 0), (448, BUTTONS_HEIGHT)], fill=(255, 255, 255, 32), outline=None, width=1)
...
def round_resize(img, corner, scaled_by):
    ...
    mask = Image.new("RGBA", img.size, fill=(0,0,0,0))
    draw = ImageDraw.Draw(mask)
    draw.rounded_rectangle([(0, 0), img.size], corner, fill=(0,255,0,255))
