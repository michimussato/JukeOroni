...
def buttons_img_overlay(labels, stby=False):
    ...
    draw_buttons.rectangle([(0, 0), (448, BUTTONS_HEIGHT)], fill=(255, 255, 255, 128), outline=None, width=1)
    ...
    comp_buttons = comp_buttons.crop((0, 0, comp_buttons.size[0]-BUTTONS_HEIGHT, 0))
