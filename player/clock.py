...
class Clock:
    ...
    def get_clock(draw_logo, draw_date, size=448, hours=12, draw_astral=False):
        ...
        draw.arc(size_h, start=(arc_twelve + arc_length_h - round(_size * ANTIALIAS**2 * 0.007)) % 360, end=(arc_twelve + arc_length_h + round(_size * ANTIALIAS**2 * 0.007)) % 360, fill=color,
                 width=width)
