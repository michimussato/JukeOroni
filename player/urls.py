...
urlpatterns = [
    ...
    path('meditationbox/<int:queue_index>/pop/', JukeOroniView.pop_track_from_queue, name='jukebox pop track'),
    path('jukebox/<int:queue_index>/as_first/', JukeOroniView.set_first_in_queue, name='jukebox pop track'),
    path('meditationbox/<int:queue_index>/as_first/', JukeOroniView.set_first_in_queue, name='jukebox pop track'),
