...
urlpatterns = [
    ...
    path('jukebox/albums/search/', AlbumView.as_view(), name='search_albums_jukebox'),
    path('meditationbox/albums/search/', AlbumView.as_view(), name='search_albums_meditationbox'),
