...
sudo mkdir -p /data/django/jukeoroni;
sudo chown -r pi:pi /data;

git clone https://github.com/michimussato/jukeoroni.git /data/django/;

cd /data/django/jukeoroni || return;

git checkout develop;

# run this script:
# curl https://raw.githubusercontent.com/michimussato/JukeOroni/develop/install.sh | bash
#        https://raw.githubusercontent.com/michimussato/jukeoroni/develop/old/install.sh
printf "hello"
